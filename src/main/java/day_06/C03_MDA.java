...
public class C03_MDA {
     ...
     public static void main(String[] args) {
         ...
         for (int i = 0; i < arr.length; i++) {//bu loop dıştaki arraylaerin elemanlarını tek tek alır
             for (int j = 0; j < arr[i].length; j++) {//bu loop iç arraylerin elemanlarını tek tek alır

                 //arr[0][0]
                 System.out.println("lutfen eklemek istediğiniz sayıyı girin");
                 System.out.println();

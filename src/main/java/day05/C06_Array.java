...
public class C06_Array {
    public static void main(String[] args) {
        ...
        //loopun bir dongusu bittiği anda arraye assign ettiğimiz variablelar sabit kalir
        //ancak loop içinde oluşturdugumuz variable lar yok olur loop her calıştıgında tekrar oluşur
        ...
        //ilk önce for each ile arrayin elemanlarını toplayalım,daha sonra eleman sayısına bölelim

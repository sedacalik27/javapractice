...
public class C01_DateTime {
        ...
        public static void main(String[] args) {
            ...
            //23/6/15 ==> 69/7/4 sekilde konsola yazdırınız

            //format değiştirmek için en başta bir variable a ihtiyacımız var
            //M mount
            //m minute
            ...
            if(dogAli.equals(dogVeli)){//== kullanamayız çünkü == ifadesi hem degerleri hem referanslari kontrol eder.
                System.out.println("ayni tarihte dogmuşlar");
            }else{
                System.out.println("ayni tarihte dogmamişlar");
            }

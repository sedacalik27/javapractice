...
public class Co8_Overloading {
    ...
    private static void cikarma(double v, int v1) {
        System.out.println("Ilki int ikincisi double iki degerin farkı : " +(v-v1));
    }
    ...
    private static void carpma(int a, int b, int c, int d) {
        System.out.println("dort int degerin carpimi : "+ (a*b*c*d) );
    }

    private static void carpma(int i, int i1, int i2) {
        System.out.println("uc int degerin carpimi:  " +(i*i1*i2) );
    }
    ...
    public static void toplama(int i, int i1) {
        System.out.println("iki int degerinin toplami :  " + (i+i1) );
    }
